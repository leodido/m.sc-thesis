...
% collegarsi all'immagine
% parlare delle statistiche (quando vengono raccolte)
% tabella
% La~\vref{tab:} mostra l'equivalenza fra la durata dei passi temporali di \acs{FREESIM} e ...

La gestione del tempo che \acs{CORSIM} attua implica quindi alcuni vincoli:
\begin{itemize}
...
%The output of cumulative simulation statistics is
...
%as specified on Record Type 04. 
