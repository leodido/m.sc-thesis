...
\vspace*{8pt}\begin{lstlisting}[caption={[Rilevazione del passaggio dei veicoli sui sensori]Rilevazione del passaggio dei veicoli sui sensori}, label=lst:process-sensors, language=cpp]
