...
\vspace*{8pt}\lstinputsourcecode[language=cpp, caption=Costrutto per l'esportazione delle funzioni \acs{RTE}, label=lst:callpoint-api]{codes/callpointapi.cpp}

\vspace*{8pt}\lstinputsourcecode[language=cpp, caption=Esempio di funzione \acs{RTE} esportata, label=lst:callpoint-impl]{codes/callpointimpl.cpp}
...
\vspace*{8pt}\lstinputsourcecode[language=cpp, caption=Importazione delle \acsfont{CORWIN} \acs{API}, label=lst:corwin-api]{codes/corwinapi.cpp}
...
\vspace*{8pt}\lstinputsourcecode[language=cpp, caption=Costrutto per l'importazione delle \acs{CORSIM} \acs{API}, label=lst:corsim-api-dll-import]{codes/corsimapidllimport.cpp}
...
\vspace*{8pt}\lstinputsourcecode[language=cpp, caption=Importazione di oggetti delle \acs{CORSIM} \acs{API}, label=lst:corsim-api]{codes/corsimapi.cpp}
...
\vspace*{8pt}\lstinputsourcecode[caption={[Rilevazione del passaggio dei veicoli sui sensori]Metodo della classe \lstinline[]|CLink| per la rilevazione del passaggio dei veicoli sui sensori}, label=lst:process-sensors, language=cpp]{codes/processsensors.cpp}
