...
Si consideri innanzitutto un singolo \mprocess*{}. Si ricorda (si vedano a tal riguardo le~\cref{defn:im,defn:mixed-parametrization}~\vpageref{defn:im,defn:mixed-parametrization}) che un \mprocess*{} ha due insiemi di parametri: $\param{$\theta$}$ che parametrizzano una \emph{distribuzione multinomiale\index{distribuzione!multinomiale}} e $\param{q}$ che parametrizzano una \emph{distribuzione esponenziale\index{distribuzione!esponenziale}}.
...
\end{equation}
Invece, dalla \emph{local parameter independence\index{parameter!independence}} consegue che è possibile scrivere:
\footnotesize
