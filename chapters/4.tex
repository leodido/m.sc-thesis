...
Perciò, in questo capitolo si descrivono i principali aspetti del \pacchettor{}\index{pacchetto \acsfont{R}|see{\acsfont{R} (linguaggio)}}, preposto a tale scopo.
...
In questa sezione si descrive per grandi linee il \pacchettor{}\index{\acsfont{R} (linguaggio)!\acsfont{RCTBN}}.
