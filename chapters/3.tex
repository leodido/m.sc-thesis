...
La funzione di \emph{\keyword{scoring}} con cui tali insiemi di genitori vengono valutati, rappresentata nell'\autoref{lst:hc-pseudo} dalla funzione \lstinline[]|score|, relativamente all'\keyword{apprendimento strutturale} di una \acs{CTBN}, corrisponde alla funzione $famscore_{\conceptsym{B}}$, presentata nella~\vref{sec:ctbn-structurallearning-score}.
