...
Si osservi che l'apprendimento dei parametri\index{parametri|see{stima}} (si veda la~\autoref{subsec:ctbn-params} \vpageref{subsec:ctbn-params}) è propedeutico per tale obiettivo poiché essi costituiscono la base dello \keyword{score bayesiano}.
