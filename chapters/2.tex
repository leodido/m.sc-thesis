...
Di conseguenza, per l'apprendimento di un \acs{CTNBC} è richiesto uno sforzo computazionale poco costoso. Per l'apprendimento di un \acs{CTTANBC}, poiché questo modello prevede archi anche fra i nodi attributo, è invece richiesto uno sforzo computazionale leggermente maggiore~\citep{Stella2012}.
