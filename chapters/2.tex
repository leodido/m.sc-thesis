...
Il classificatore \acs{CTBN} classifica\index{classificazione!\acsfont{CTBNC}} quindi il flusso di evidenze massimizzando la seguente probabilità a posteriori, ricavata applicando la \emph{\keyword{regola di Bayes}}:
