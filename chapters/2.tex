...
Mentre nella \autoref{sec:learning-ctbnc} si affronta il processo di \emph{apprendimento} in caso di \emph{\keyword{dati completi}} dei \acs{CTBNC}, nella \autoref{sec:inference-ctbnc} si presenta un algoritmo di \emph{\keyword{inferenza} esatta} per la classe dei \acs{CTBNC}.
