...
In questa sottosezione si presentano i risultati di ogni processo di \emph{\keyword{classificazione supervisionata}} effettuato con ognuno $4$ modelli di classificatori. Nello specifico, per ogni dataset sottoposto a sperimentazione, si illustra il valore della metrica \emph{\keyword{accuracy}} relativo ad ognuno dei classificatori utilizzati.
