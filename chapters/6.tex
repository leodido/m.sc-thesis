...
\begin{table}
	...
	\end{tabular}
	\caption[Flussi di ingresso relativi al \ds{2}]{Numero di veicoli orari immessi nella rete stradale del dataset \ds{2} al variare del periodo temporale.}
	\label{tab:ds-2-input-vehicles}
\end{table}

Si osservi, inoltre, che al fine di definire il succitato andamento del traffico è stata attuata un'adeguata modellazione delle percentuali di svolta in ogni intersezione. Tuttavia, a causa della complessità del modello, non è possibile riportare le variazione delle percentuali di svolta di ogni intersezione per ogni periodo temporale.
