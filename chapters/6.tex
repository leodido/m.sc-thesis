...
\subfloat[]{\includegraphics[width=1\columnwidth]{tsis-model-simple-dx}}\cleardoublepage
\subfloat[]{\includegraphics[width=1\columnwidth]{tsis-model-simple-sx}}
\captionof{figure}[Rete stradale del \ds{1}]{Visualizzazione del file \acs{TNO} rappresentante la rete stradale da cui viene generato il \ds{1}.}
\label{fig:tsis-model-simple}
\end{center}
