...
A partire da essa è possibile calcolare
\begin{table}
	\footnotesize
	\centering%
    ...
    \end{tabular}
    \caption[Esempio di \keyword{matrice di contingenza}]{Esempio di \emph{\keyword{matrice di contingenza}} specifico del problema di \emph{\keyword{classificazione multi-classe}} affrontato.}\label{tab:contingency-table}
\end{table}
\normalsize
