...
In questa sottosezione si presentano i risultati dei processi di \emph{\keyword{classificazione supervisionata}} dei $6$ dataset effettuati per ognuno dei $4$ modelli di classificatori presi in considerazione. Per ogni dataset sottoposto a sperimentazione si illustra e commenta il valore della metrica \emph{\keyword{accuracy}} relativo ad ognuno dei classificatori utilizzati. Si rimarca che la metrica \emph{\keyword{accuracy}} è stata calcolata tramite approccio \emph{\keyword{micro-average}} su tutti i \emph{\keyword{fold}} di ogni sperimentazione.
\cleardoublepage
\begin{table}
	\centering
