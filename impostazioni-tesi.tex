...
\hypersetup{%
    ...
    pdfsubject={Continuos time Bayesian network classifiers},%
    pdfkeywords={},%
    pdfcreator={pdfLaTeX},%
...
% parole comuni
\newcommand{\ctbn}{continuos time Bayesian network}
\newcommand{\ctbnc}{continuos time Bayesian network classifier}
\newcommand{\bn}{Bayesian Network}
\newcommand{\mprocess}{Markov process}
\newcommand{\omprocess}{homogeneus Markov process}
\newcommand{\cmprocess}{conditional Markov process}

% elementi matematici comuni
\newcommand{\cim}[1]{\set{Q}^{pa(#1)}_{#1}}
\newcommand{\prior}[1]{\set{P}^0_{#1}}
