...
Tali premesse costituiscono il movente di questo lavoro di tesi, il cui obiettivo principale è presentare un framework alternativo, le \acf{CTBN} \citep{Nodelman2007}.
...
Questo lavoro di tesi è quindi composto da una serie di contributi sviluppati attorno all'argomento principale. Si elencano sinteticamente gli argomenti affrontati:
\begin{itemize}
	...
	\item definizione, a partire dalle \acl{CTBN}, di una nuova classe di classificatori, i \acf{CTBNC} \citep{Stella2012}; e introduzione di due istanze di tale classe, in particolare del classificatore \acl{CTNB} (\acs{CTNBC})
