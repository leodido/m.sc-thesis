...
Qualsiasi processo di apprendimento strutturale basato su punteggio è costituito da due componenti: una \emph{\keywordsub[apprendimento]{funzione di scoring}} e una procedura di ottimizzazione.
...
Si definisce lo \emph{\keywordsub[apprendimento]{score bayesiano}} sul grafo $\conceptsym{G}$ di una \acs{CTBN} nel seguente modo:
