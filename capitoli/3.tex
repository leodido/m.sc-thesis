...
In questa sezione si affronta il problema della \emph{\keyword{classificazione}} (o \emph{\keywordsub[classificazione]{inferenza esatta}}) da un $J$-evidence-stream completamente osservato.
