...
In questa sezione si è presentato come computare la likelihood di un modello di una \acs{CTBN} rispetto a un dataset completo; informazione che ha un chiara relazione, tramite il \emph{teorema di Bayes}, con la probabilità di un dataset completo dato un modello di una \acs{CTBN}.
