...
Relazione fra i parametri: thetaij = qij / qi

Il reciproco di qx|u (1/qx|u), parametro della distribuzione esponenziale, è
il tempo medio di transizione uscente da x (quando U = u)
Il numero medio di transizioni uscenti da x che portano a x' è esattamente
M[x,x'|u]/M[x
