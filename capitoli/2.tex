...
\[
q_{x_i}=\sum_{i \neq j}q_{x_ix_j}\quad\text{con}\quad q_{x_i}\,,\,q_{x_ix_j}>0\text{.}
\]
...
F(t) &= 1-\exp(-q_{x_i}\,t)\,,\quad t\geq0\text{.}
\end{split}
\end{equation}
...
\begin{esempio}[Matrice di intensità \cond*{}]\label{ex:cim}
bla bla
\end{esempio}
Prova autoref: \autoref{ex:cim}.
